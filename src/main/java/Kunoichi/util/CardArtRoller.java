...
public class CardArtRoller {
    private static final Texture attackMask = TexLoader.getTexture(KunoichiMod.modID+"Resources/images/masks/AttackMask.png");
    private static final Texture skillMask = TexLoader.getTexture(KunoichiMod.modID+"Resources/images/masks/SkillMask.png");
    private static final Texture powerMask = TexLoader.getTexture(KunoichiMod.modID+"Resources/images/masks/PowerMask.png");
