...
public class TheKunoichi extends CustomPlayer {
    ...
    static final String ID = makeID("TheKunoichi");
    static final CharacterStrings characterStrings = CardCrawlGame.languagePack.getCharacterString(ID);
    static final String[] NAMES = characterStrings.NAMES;
    static final String[] TEXT = characterStrings.TEXT;


    public TheKunoichi(String name, PlayerClass setClass) {
    ...
    public ArrayList<String> getStartingRelics() {
        ArrayList<String> retVal = new ArrayList<>();
        retVal.add(Scroll.ID);
        return retVal;
    }

    @Override
    public void doCharSelectScreenSelectEffect() {
        CardCrawlGame.sound.playA("ATTACK_DAGGER_4", MathUtils.random(-0.2F, 0.2F));
    ...
    public AbstractCard.CardColor getCardColor() {
        return DARK_GUNMETAL_COLOR;
    }

    @Override
    public Color getCardTrailColor() {
        return DARK_GUNMETAL.cpy();
    }
    ...
    public AbstractPlayer newInstance() {
        return new TheKunoichi(name, chosenClass);
    }
    ...
    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_KUNOICHI;
        @SpireEnum(name = "DARK_GUNMETAL_COLOR")
        public static AbstractCard.CardColor DARK_GUNMETAL_COLOR;
        @SpireEnum(name = "DARK_GUNMETAL_COLOR")
