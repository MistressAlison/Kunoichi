package Kunoichi.cards.abstracts;

import Kunoichi.KunoichiMod;
import Kunoichi.patches.TypeOverridePatch;
import Kunoichi.util.ImageHelper;
...
public abstract class AbstractPowerCard extends AbstractEasyCard {
    ...
    public AbstractPowerCard(AbstractPower power) {
        super(KunoichiMod.makeID(power.ID+"Card"), -2, CardType.SKILL, CardRarity.SPECIAL, CardTarget.NONE, CardColor.COLORLESS);
