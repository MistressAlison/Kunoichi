...
public class RandomChatterHelper {
    ...
    private static final CardStrings AttackTextContainer = CardCrawlGame.languagePack.getCardStrings(KunoichiMod.makeID("AttackTextContainer"));

    private static final CardStrings SkillTextContainer = CardCrawlGame.languagePack.getCardStrings(KunoichiMod.makeID("SkillTextContainer"));

    private static final CardStrings PowerTextContainer = CardCrawlGame.languagePack.getCardStrings(KunoichiMod.makeID("PowerTextContainer"));

    private static final CardStrings BattleStartTextContainer = CardCrawlGame.languagePack.getCardStrings(KunoichiMod.makeID("BattleStartTextContainer"));

    private static final CardStrings LowHPBattleStartTextContainer = CardCrawlGame.languagePack.getCardStrings(KunoichiMod.makeID("LowHPBattleStartTextContainer"));

    private static final CardStrings BattleEndTextContainer = CardCrawlGame.languagePack.getCardStrings(KunoichiMod.makeID("BattleEndTextContainer"));

    private static final CardStrings BossFightTextContainer = CardCrawlGame.languagePack.getCardStrings(KunoichiMod.makeID("BossFightTextContainer"));

    private static final CardStrings HealingTextContainer = CardCrawlGame.languagePack.getCardStrings(KunoichiMod.makeID("HealingTextContainer"));

    private static final CardStrings FieldDamageTextContainer = CardCrawlGame.languagePack.getCardStrings(KunoichiMod.makeID("FieldDamageTextContainer"));

    private static final CardStrings LightDamageTextContainer = CardCrawlGame.languagePack.getCardStrings(KunoichiMod.makeID("LightDamageTextContainer"));

    private static final CardStrings HeavyDamageTextContainer = CardCrawlGame.languagePack.getCardStrings(KunoichiMod.makeID("HeavyDamageTextContainer"));

    private static final CardStrings BlockedDamageTextContainer = CardCrawlGame.languagePack.getCardStrings(KunoichiMod.makeID("BlockedDamageTextContainer"));

    private static final CardStrings KOTextContainer = CardCrawlGame.languagePack.getCardStrings(KunoichiMod.makeID("KOTextContainer"));
