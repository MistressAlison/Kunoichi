...
import Ordnance.util.CardArtRoller;

import java.util.ArrayList;

import static Ordnance.OrdnanceMod.*;
import static Ordnance.util.Wiz.atb;
import static Ordnance.util.Wiz.att;
...
public abstract class AbstractEasyCard extends CustomCard {
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        this(cardID, cost, type, rarity, target, TheMunitions.Enums.SANGUINE_RED_COLOR);
    }
