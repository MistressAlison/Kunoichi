...
import Ordnance.cards.BasicShot;
import Ordnance.cards.Reclaim;
import Ordnance.cards.interfaces.SkillAnimationAttack;
...
import Ordnance.cards.Defend;
import Ordnance.cards.Strike;
import Ordnance.relics.TodoItem;

import java.util.ArrayList;

import static Ordnance.TheMunitions.Enums.SANGUINE_RED_COLOR;
import static Ordnance.OrdnanceMod.*;

public class TheMunitions extends CustomPlayer {
    ...
    static final String ID = makeID("TheMunitions");
    static final CharacterStrings characterStrings = CardCrawlGame.languagePack.getCharacterString(ID);
    static final String[] NAMES = characterStrings.NAMES;
    static final String[] TEXT = characterStrings.TEXT;


    public TheMunitions(String name, PlayerClass setClass) {
    ...
    public AbstractCard.CardColor getCardColor() {
        return SANGUINE_RED_COLOR;
    }

    @Override
    public Color getCardTrailColor() {
        return SANGUINE_RED.cpy();
    }
    ...
    public AbstractPlayer newInstance() {
        return new TheMunitions(name, chosenClass);
    }
    ...
    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_MUNITIONS;
        @SpireEnum(name = "SANGUINE_RED_COLOR")
        public static AbstractCard.CardColor SANGUINE_RED_COLOR;
        @SpireEnum(name = "SANGUINE_RED_COLOR")
    ...
    public void preBattlePrep() {
        playAnimation("idle");
        super.preBattlePrep();
        AbstractDungeon.actionManager.addToTop(new ApplyPowerAction(this, this, new AmmoPower(this, 999)));
